...
import controller.util.JPADataModel;
...
public class PersonBean implements Serializable {
    ...
    private static final class Acte_NaissanceDataModel extends JPADataModel<Acte_Naissance> {
        private Acte_NaissanceDataModel(EntityManager entityManager) {
            super(entityManager, Acte_Naissance.class);
        }
 
        @Override
        protected Object getId(Acte_Naissance t) {
            return t.getId();
        }
    }
    ...
    private EntityManager lookupEntityManager() {
        ...
        session.Acte_NaissanceFacade persistenceService = facesContext.getApplication().evaluateExpressionGet(facesContext,
                "#{persistenceService}", session.Acte_NaissanceFacade.class);
    ...
    public Object getDataModel() {
        return new Acte_NaissanceDataModel(lookupEntityManager());
    }
}