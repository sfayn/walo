 ...
 */
@Entity
@Table( name="registre_jugement_deces",
        uniqueConstraints=
            @UniqueConstraint(columnNames={"numReg", "annee"})
    )
public class Registre_jugement_Deces implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        Registre_jugement_Deces other = (Registre_jugement_Deces) object;
