 ...
 */
@Entity
@Table( name = "registre_transcription",
        uniqueConstraints=
            @UniqueConstraint(columnNames={"numReg", "annee"})
    )
public class Registre_Transcription implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        Registre_Transcription other = (Registre_Transcription) object;
