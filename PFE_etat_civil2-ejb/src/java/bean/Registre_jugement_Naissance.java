 ...
 */
@Entity
@Table( name="registre_jugement_naissance",
        uniqueConstraints=
            @UniqueConstraint(columnNames={"numReg", "annee"})
    )
public class Registre_jugement_Naissance implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        Registre_jugement_Naissance other = (Registre_jugement_Naissance) object;
